...
# ANSWER: The train data and test data has to be different,suppose if we take same values we get overfit graph so to get the optimum solution we need to choose different values
...
interact(plot_fit, degree=[1, 5, 10, 30], Npts=[2, 10, 50, 100]);
